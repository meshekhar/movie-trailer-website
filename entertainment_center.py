...
power_rangers = media.Movie("Power Rangers", 
                        "A group of high-school kids, who are infused with "
                        "unique superpowers, harness their abilities in order"
                        " to save the world.",
...
beauty_and_the_beast = media.Movie("Beauty and the Beast", 
                        ...
                        "independent young woman, is taken prisoner by "
                        "a beast (Dan Stevens) in its castle. ",
...
the_boss_baby = media.Movie("The boss baby", 
                        "A new baby's arrival impacts a family, told from the"
                        " point of view of a delightfully unreliable narrator "
...
the_matrix = media.Movie("The Matrix", 
                        ...
                        "and directed by The Wachowski Brothers, starring "
...
lord_of_the_rings = media.Movie("The Lord of the Rings", 
                        "Journey to Middle-earth via the official The Lord of "
                        "the Rings website. Get the insider scoop on the latest"
                        " news, products and new content",
